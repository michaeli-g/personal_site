    ...
    if (window.innerWidth < window.innerHeight) {
        return (
            <div class="col-lg-6 text-center">
                ...
                <p class="lead">
                    I'm currently a software developer for the Department of Defense. My current role primarily consists of overseeing
                    the production and testing of our software, with a heavy focus in automation. Along with this I've developed infrastructure for my team improving workflow, maintain build machines we use for production/testing and manage the teams archive. Some of the current tech I use is shown
